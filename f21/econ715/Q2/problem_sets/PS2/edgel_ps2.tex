...
\end{center}
Using the sample shares of years of experience, the average treatment effect (ATE) is estimated as \input{2b.tex}. Using a single sample of 400 observations, the ATE is estimated as \input{3.tex}. A histogram of ATE estimates from 500 samples of 400 observations is shown below.\footnote{All samples were taken without replacement.}
\begin{center}
