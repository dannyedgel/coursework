...
\begin{itemize}
	...
	\item[b)] With a proportion $\alpha$ of consumers who can observe the quality of the good, the seller now has an incentive to produce a high-quality good. Suppose the sellser chooses ${q=1}$. Then, to choose the price, the seller solves:
		\begin{align*}
			...
			&				&				&p-c_1\geq 0								&\text{ (IR)}
		\end{align*}
		Thus, in any equilibrium where the firm chooses ${q=1}$ and ${p=1}$, where:
		\[
			p \geq \frac{c_1}{\alpha}
		\]
		This equilibrium is only possible, then, if ${\alpha\geq c_1}$. Otherwise, the firm's incentive compatability constraint will not be satisfied at any price that informed consumers are willing to pay for the good.
