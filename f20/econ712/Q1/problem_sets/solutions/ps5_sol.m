...
%WITH SS: Set tau=0.11, and change line: 309-310
...
K0=3.1392;
L0=0.3496;
% With correct code, default tolerance levens and this initial guess, the
% algorithm converges in less than 30 iterations.

%      k0         l0       w         r         ss0
%    3.1392    0.3496    1.4104    0.0284    0.2223
    ...
    for j=tW:-1:1           % age
        for ik0=1:nk          % assets today
            ...
            while ik1 < nk  	% assets tomorrow
                ...
                % Instantaneous utility
                cons=(1+r0)*kap0+(1-tau)*w0*e(j)*lab-kap1;
...
% save figures to pdf
set([1, 2], 'PaperSize', [5 5]);
set([1, 2], 'PaperPositionMode', 'manual');
set([1, 2], 'PaperPosition', [0 0 5 5]);
print(1, 'fig_val', '-dpdf');
print(2, 'fig_kp', '-dpdf');
