...
\begin{enumerate}[(a)]
	...
	\item % The equilibrium bidding strategy does not directly depend on $p$. As ${q\rightarrow0}$, the equilibrium bidding strategy tends toward 1 regardless of the player's valuation. As ${q\rightarrow1}$, the equilibrium 
